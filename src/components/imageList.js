  ...
  if (!images.length && !searchInput.current?.value && !loading) {
    return (
      <div className="Album-container">
        ...
        {addImageIntent && <ImageForm loading={imgLoading} onAdd={handleAdd} albumName={albumName} />}
      </div>
    );
  }
  ...
  return (
    <div className="Album-container">
      ...
      <div className="top">
        ...
        {updateImageIntent && (
          <button onClick={() => setUpdateImageIntent(false)}>Cancel</button>
        )}
        {!updateImageIntent && (
          <button
            className={addImageIntent ? "active" : null}
      ...
      {!loading && (
        <div className="imageList">
          {images.map((image, i) => (
            ...
            >
              <div
                className={`update ${activeHoverImageIndex === i && "active"}`}
                onClick={(e) => {
                  e.stopPropagation();
              ...
              <div
                className={`delete ${activeHoverImageIndex === i && "active"}`}
              ...
              <img
                ...
                onError={({ currentTarget }) => {
                  currentTarget.src =
                    "https://www.pngmart.com/files/17/Caution-Warning-PNG-Clipart.png";
                }}
              />
